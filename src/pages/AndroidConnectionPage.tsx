...
export default function AndroidConnectionPage() {
  ...
  const [transport, setTransport] = useState<'websocket' | 'http' | 'native'>('http');
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && (window as any).HandsBridge) {
      setTransport('native');
      setEndpoint('embedded');
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
          ...
          <ol className="space-y-3 text-slate-300"><li>1. Install Svetlana-App.</li><li>2. Open Android Accessibility settings and enable Svetlana.</li><li>3. Keep Svetlana-App running; its loopback execution server starts automatically.</li><li>4. In an embedded Svetlana WebView select Native WebView, or use HTTP/WebSocket from an external Control Plane.</li></ol>
